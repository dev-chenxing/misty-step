...
- [ ] feat: implement "misty step" effect logic
  ...
  - [x] feat: if the ray hits something, clamp the blink distance to hit.distance minus a safety buffer (e.g. 1 ft); if it does not hit, use the full blink distance
